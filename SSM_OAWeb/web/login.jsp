			...
			<div class="col-md-offset-3 col-md-6">
				...
				<form class="form-horizontal" action="login" method="post" id="loginForm">
					...
					<div class="form-group">
						<div class="col-sm-10">
						<input id="user" type="text" name="username" class="form-control" id="username"
					...
					<div class="form-group">
						...
						<span>${errorMsg}</span>
						<div class="col-sm-10">
							<button type="submit" id="sub" name="sub" class="btn btn-primary" onclick="return check()">登录</button>
						</div>
					</div>
				</form>
			</div>
